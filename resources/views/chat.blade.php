              ...
              <div class="card-body">
                ...
                <div class="ui grid">
                    ...
                    <div class="ten wide column">
                        <div class="ui fluid card chat-box">
                          <div class="greentop content">
                            <div class="header">Chat with Ryan</div>
                            <div class="meta">
                              <span>Last seen 2 days ago</span>
                            </div>
                          </div>
                          <div class="content cont-desc">
                            <div class="description chat-content">
                              <div class="ui large list fluid" style="max-width: none;">

                                <div class="chat-item chat-left" style="">
                                  <img src="/img/avatar/small/matt.jpg">
                          ...
                          <div class="extra content">
                            <div class="ui action fluid transparent input">
                              ...
                              <button class="ui teal icon button" style="background:#1c9639 !important">
